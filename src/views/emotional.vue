<template>
    <div>
        ...
        <TableSearch :formItem="formItem" @search="handleSearch"/>
            ...
            @change="handleChange"
            />
            <el-dialog v-model="detailDialogVisible" title="情绪日志详情" width="800px">
                    ...
                    <div class="detail-section">
                        ...
                        <div class="ai-improvements-section">
                            ...
                            <ul class="improvement-list">
                                <li v-for="(item, index) in aiData.improvementSuggestions" :key="index">
                                    {{item}}
                                </li>
                            </ul>
                        </div>
...
import { getEmotionPage, deleteEmotional } from '../api/admin.js'
...
const viewSessionDetail = (row) => {
    ...
    if(row.aiEmotionAnalysis) {
        ...
        console.log(aiData.value, 'AI分析数据');
    } else {
        aiData.value = {};
    }
