        ...
        <div class="sidebar">
            ...
            <div class="ai-assistant-info">
                <div class="breathing-circle">
                    <el-image :src="iconUrl" fit="cover" style="width: 25px; height: 25px;"></el-image>
                </div>
            ...
            <div class="emotion-garden">
                ...
                <div class="warm-tips">
                    ...
                    <!-- 温暖建议卡片 -->
                     <div class="warm-suggestion" v-if="currentEmotion.improvementSuggestions.length > 0">
                    ...
                    <!-- 治愈行动卡片 -->
                    <div class="healing-actions" v-if="currentEmotion.isNegative">
                    ...
                    <div v-for="session in sessionList" :key="session.id" @click="handleSessionClick(session)" class="session-item">
                        <div class="session-info">
                            <div class="session-title">
                                ...
                                {{ session.lastMessageContent || '暂无消息预览' }}
                                </div>
                            ...
                            <div class="session-actions">
                                <el-button text type="danger" size="small" @click="handleDeleteSession(session.id)" title="删除会话">
                                    <el-icon>
                                        <DeleteFilled />
                                    </el-icon>
                                </el-button>
            ...
            <div class="chat-header">
                <div class="header-left">
                    <div class="chat-avatar">
                        <el-image :src="iconUrl1" fit="cover" style="width: 30px; height: 30px;"></el-image>
                    </div>
                    <div class="chat-info">
                        <h2>宁渡AI助手</h2>
                        <p>您的贴心AI心理健康助手</p>
            ...
            <div class="chat-messages">
                ...
                <div class="message-item ai-message" v-if="messages.length === 0">
                    <div class="message-avatar">
                        <el-image :src="iconUrl" fit="cover" style="width: 18px; height: 18px;"></el-image>
                    </div>
                ...
                <!-- 会话列表 -->
                 <div v-for="msg in messages" :key="msg.id"  class="message-item" :class="msg.senderType === 1 ? 'user-message' : 'ai-message'">
                    <div class="message-avatar">
                        <el-image v-if="msg.senderType === 1" :src=iconUrl2 fit="cover" style="width: 18px; height: 18px;"></el-image>
                        <el-image v-if="msg.senderType === 2" :src=iconUrl fit="cover" style="width: 18px; height: 18px;"></el-image>
                    </div>
                    <div class="message-content">
                        <div class="message-bubble">
                            <!-- AI助手正在输入中... -->
                            ...
                            <!-- 用户消息 -->
                            <p v-else-if="msg.content" v-html="formatMessageeContent(msg.content)"></p>
                        </div>
            ...
            <div class="chat-input">
                <div class="input-container">
                    ...
                    <div class="input-footer">
                        <span>按 Enter 发送消息,Shift+Enter换行</span>
                        <span>{{ userMessage.length }}/500</span>
                    </div>
                </div>
                <el-button :disabled="!userMessage.trim() || userMessage.length > 500"  type="primary" class="send-btn" @click="sendMessage" title="发送消息">
                    <el-icon>
                        <Promotion />
                    </el-icon>
                </el-button>
...
import {startSession, getSessionList, deleteSession, getMessageList, getSessionEmotion} from "@/api/frontend"
...
const startAIResponse = (sessionId, userMessage) => {
    ...
    //调用后端接口获取AI回复
    const ctrl = new AbortController()  // 用来终止fetch请求，防止内存泄漏
    fetchEventSource(`/api/psychological-chat/stream`, {
        ...
        onopen: (response) => {
            if (response.headers.get("Content-Type") !== "text/event-stream") {
                ElMessage.error("服务器返回的内容类型不正确，无法建立连接！")
            }
        },
        //正常情况
        onmessage: (event) => {
            ...
            if(ok && payload.data && payload.data.content) {
                ...
                //如果后端返回错误，显示错误信息
                handleError(payload.message || "AI助手回复消息失败，请稍后再试！")
            }
        },
        onerror: (err) => {
            handleError(err || "AI助手回复消息失败，请稍后再试！")
            throw err
        },
         onclose: () => {
            //开始情绪分析
...
const handleError = (error) => {
    ...
    if(aiMessage) {
        ...
        aiMessage.content = "AI助手回复消息失败，请稍后再试！"
    }
    isAiTyping.value = false
    ElMessage.error("AI助手回复消息失败，请稍后再试！")
}
const getSessionPage = (sessionId) => {
    getSessionList({
            pageNum: 1,
            pageSize: 20
    }).then(res => {
...
//处理简单换行逻辑
const formatMessageeContent = (content) => {
    if (!content) return ''
